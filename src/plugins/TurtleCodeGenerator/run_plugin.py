"""
This script is called by the plugin-wrapper, TurtleCodeGenerator.js, which passes down the
...
from TurtleCodeGenerator import TurtleCodeGenerator
...
plugin = TurtleCodeGenerator(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
