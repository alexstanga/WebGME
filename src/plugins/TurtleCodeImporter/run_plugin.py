"""
This script is called by the plugin-wrapper, TurtleCodeImporter.js, which passes down the
...
plugin = TurtleCodeImporter(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
