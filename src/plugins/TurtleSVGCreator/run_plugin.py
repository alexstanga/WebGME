"""
This script is called by the plugin-wrapper, TurtleSVGCreator.js, which passes down the
...
from TurtleSVGCreator import TurtleSVGCreator
...
plugin = TurtleSVGCreator(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
